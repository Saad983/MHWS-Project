...
import 'package:mhws/view/assessment/select_stress_level_view.dart';
...
class AddMentalSymptomView extends StatelessWidget {
  AddMentalSymptomView({super.key});

   

  final List<String> describeYourselfSuggestions = ["Depressed", "Angry"];
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            8.verticalSpace,
            ButtonWithArrow(
              onTap: () => Get.to(() => SelectStressLevelView()),
              text: "Continue",
              width: 343.w,
            )
          ],
